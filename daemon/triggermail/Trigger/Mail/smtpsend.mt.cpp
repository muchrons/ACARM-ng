/*
 * NOTE: this file is not a part of ACARM-ng - it is slightly
 *       changed usage example taken from libetpan's distribution file.
 */
...
void logger(int direction, const char * str, size_t size)
{
