...
struct Cfg: public NamedConfig<Cfg>
{
  Cfg(void):
    NamedConfig<Cfg>( "type1", "name", makeOptions() )
  {
  }
...
factory tf("ConfigIO/Generic/NamedConfig");
} // unnamed namespace
...
{
  ensure_equals("invalid type", cfg_.getName(), "name");
}
