 ...
 *
 */
#ifndef INCLUDE_INPUT_PRELUDE_IDMEFPARSERALERT_HPP_FILE
#define INCLUDE_INPUT_PRELUDE_IDMEFPARSERALERT_HPP_FILE
 ...
 */
class IDMEFParserAlert : private boost::noncopyable
{
public:
  /**
   ...
   */
  IDMEFParserAlert(idmef_message_t *msg, BackendFacade &bf);
