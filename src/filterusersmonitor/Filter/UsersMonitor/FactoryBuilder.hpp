 ...
 *
 */
#ifndef INCLUDE_FILTER_USERSMONITOR_FACTORYBUILDER_HPP_FILE
#define INCLUDE_FILTER_USERSMONITOR_FACTORYBUILDER_HPP_FILE
...
/** \brief builds users' monitoring filter.
 */
