...
void testObj::test<1>(void)
{
  ...
  ensure_equals("invalid certainty delta", ma.getCertaintyDelta(), 0);
...
{
  ensure_equals("invalid certainty delta", ma_.getCertaintyDelta(), 4.2);
}
...
// test equality with different certainty
template<>
template<>
