...
factory tf("Algo/MPL/EnsureNodePtrNotNULL");
} // unnamed namespace
...
void testObj::test<1>(void)
{
  ...
  typedef EnsureNodePtrNotNULL<Tested>::type Out;
...
{
  //EnsureNodePtrNotNULL< shared_ptr<double> >::type b;   // error: invalid type in pointer
}
