 ...
 *
 */
#ifndef INCLUDE_DATAFACADES_STRACCESS_ONANALYZER_HPP_FILE
#define INCLUDE_DATAFACADES_STRACCESS_ONANALYZER_HPP_FILE
...
struct OnAnalyzer: private System::NoInstance
{
  ...
  static bool process(const Persistency::Analyzer &e, TParams p)
  {
