 ...
 *
 */
#ifndef INCLUDE_DATAFACADES_STRACCESS_ONPROCESS_HPP_FILE
#define INCLUDE_DATAFACADES_STRACCESS_ONPROCESS_HPP_FILE
...
struct OnProcess: private System::NoInstance
{
  ...
  static bool process(const Persistency::Process &e, TParams p)
  {
